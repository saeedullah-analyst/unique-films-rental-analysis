...
License / LizenzThis project utilizes the industry-standard Sakila database schema, which is open-source and distributed under the MIT License.Dieses Projekt verwendet das rechtlich standardisierte Sakila-Datenbankschema, welches als Open-Source-Software unter der MIT-Lizenz bereitgestellt wird.
